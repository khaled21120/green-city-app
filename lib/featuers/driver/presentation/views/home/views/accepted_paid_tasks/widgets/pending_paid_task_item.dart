...
class PendingPaidTaskItem extends StatefulWidget {
  ...
  @override
  State<PendingPaidTaskItem> createState() => _PendingPaidTaskItemState();
}

class _PendingPaidTaskItemState extends State<PendingPaidTaskItem> {
  ...
  Widget _buildTaskInfo() {
    return Column(
      ...
      children: [
        Text(
          widget.userReportsModel.institutionName ?? '',
        ...
        Text(
          '${widget.userReportsModel.startDate} - ${widget.userReportsModel.startTime}',
        ...
        Chip(
          ...
          label: Text(
            widget.userReportsModel.subscriptionType ?? '',
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(
              ...
              widget.userReportsModel.institutionAddress,
            ),
            _buildDetailRow(
              context,
              '${S.of(context).desc}:',
              widget.userReportsModel.additionalNotes,
            ),
            _buildDetailRow(
              context,
            ...
            _buildDetailRow(
              ...
              widget.userReportsModel.paymentMethod,
            ),
            _buildDetailRow(
              context,
              '${S.of(context).date}:',
              widget.userReportsModel.startDate,
            ),
            _buildDetailRow(
              context,
              '${S.of(context).price}:',
              widget.userReportsModel.price.toString(),
            ),
