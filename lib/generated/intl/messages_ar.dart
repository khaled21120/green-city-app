...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "our_mission_description": MessageLookupByLibrary.simpleMessage(
      "إنشاء مدينة أنظف وأكثر خضرة من خلال ممارسات إدارة النفايات المستدامة وحملات التوعية وحلول إعادة التدوير الحديثة.",
    ),
    "our_services": MessageLookupByLibrary.simpleMessage("خدماتنا"),
    "our_services_description": MessageLookupByLibrary.simpleMessage(
      "نحن نقدم خدمات جمع النفايات وتنظيف الشوارع ومبادرات إعادة التدوير وبرامج التوعية العامة.",
    ),
    ...
    "sign_in_with": MessageLookupByLibrary.simpleMessage(
      "تسجيل الدخول باستخدام ",
    ),
    "sign_out": MessageLookupByLibrary.simpleMessage("تسجيل الخروج"),
    "sign_up": MessageLookupByLibrary.simpleMessage("إنشاء حساب"),
    "sign_up_to_continue": MessageLookupByLibrary.simpleMessage(
    ...
    "task_report": MessageLookupByLibrary.simpleMessage("تقرير المهمة"),
